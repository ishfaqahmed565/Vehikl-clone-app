    ...
    <div class="flex flex-col items-center justify-center space-y-6">
      ...
      <div class="flex flex-row items-center space-x-[1px] text-gray-400">
        <a
          ...
          target="_blank"
          rel="noopener"
          class="p-2 lg:p-4 hover:text-gray-200 transition-all"
          ><svg
            class="w-6 h-6"
            fill="currentColor"
            role="img"
        ...
        <a
          href="https://www.linkedin.com/company/vehikl"
          target="_blank"
          rel="noopener"
          class="p-2 lg:p-4 hover:text-gray-200 transition-all"
          ><svg
        ...
        <a
          href="https://www.youtube.com/channel/UCO9DRs4ZeAojMxlOussB1jw"
          target="_blank"
          rel="noopener"
          class="p-2 lg:p-4 hover:text-gray-200 transition-all"
          ><svg
      ...
      <p class="text-gray-400 text-base">© 2022 VEHIKL</p>
    </div>
  </SectionContainer>
</template>
<style scoped></style>
