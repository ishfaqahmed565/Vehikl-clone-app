...
<template>
  <div class="flex items-center max-h-[75vh] overflow-y-hidden relative">
    <img
      src="@/assets/candid-4.jpg"
      alt=""
      class="w-full object-cover min-h-[75vh] border-b-[2px] border-gray-800"
    />
    <div
      class="absolute w-full flex items-center flex-col bg-gray-900 h-full bg-opacity-60"
    >
      <div
        class="mt-[14rem] sm:mt-32 text-center max-w-[75ch] flex flex-col items-center"
      >
