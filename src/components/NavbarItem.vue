      ...
      <div class="left mr-auto">
        <a
          ...
          >
            ...
            <path
              style="fill: #fff"
              d="M839.1 192.29v-151h41.16V157h51.16v35.27z"
            ></path>
          </svg>
        </a>
      </div>
        ...
        <div class="relative lg:hidden">
          ...
          >
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              class="w-8 h-7 text-gray-400 fill-current"
            >
              <path
                stroke-linecap="round"
                stroke-linejoin="round"
          ...
          <ModalItem :show="showClose" @close="show = false">
            <template #default> Override the default</template>
          </ModalItem>
        </div>
      </div>
    </nav>
